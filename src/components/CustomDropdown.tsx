...
export default class CustomDropdown extends React.Component<Props, State> {
    ...
    /**
     * The default reference to the dropdown list
     */
    private innerDefaultValueOfSelectedItem: Item = {
    ...
    constructor(props: Props) {
        ...
        this.state = {
            visible: false,
            dropdownTop: 0,
            selectedItem: this.props.defaultSelectedItem || this.innerDefaultValueOfSelectedItem,
        }
    ...
    /**
     * Set the default value of the selected item which none
     * label: Select Category
     * value: none
     */
    resetDefaultValueOfSelectedItem() {
        this.setState({
            selectedItem: this.innerDefaultValueOfSelectedItem,
        })
    }
